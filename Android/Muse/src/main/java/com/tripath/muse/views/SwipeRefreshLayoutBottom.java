/*
 *  SwipeRefreshLayoutBottom.java 1.0.0 2017/10/23
 *
 ...
 */
package com.tripath.muse.views;
...
/**
 * bottom쪽으로 swipe하면  새로운 아이템을 불러온다.
 */
...
public class SwipeRefreshLayoutBottom extends ViewGroup {
    ...
    // Default offset in dips from the top of the view to where the progress spinner should LAST_STOP
